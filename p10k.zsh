# Generated by Powerlevel10k configuration wizard on 2020-11-23 at 16:01 IST.
...
() {
  ...
  typeset -g POWERLEVEL9K_RBENV_SOURCES=(local)
  ...
  function prompt_dip(){
    ...
    local size=()
    if ! zstat -A size +size dip.yml 2>/dev/null; then
      # No 'dip.yml' file in the current directory.
      return
    fi
    p10k segment -i 'Ɗ' -b 'purple' -f '#ffffff'
  }
